...
# ╔═╡ e6a45936-457d-4a9c-86ca-8a688fab6378
begin
...
# ╔═╡ e0eadda3-e527-4886-85be-a06884554a64
md"# Visualize Paraboloid"

# ╔═╡ 1cfbb95f-9035-4f9b-9368-971835df185d
struct Grid
	x
	y
end

# ╔═╡ 8735d291-2421-4620-b022-2a52ad20c784
md"# Visualize Gradient Descent"

# ╔═╡ f6a1f1bc-e81c-4163-ba8a-1bbf4afc4183
md"""Problem type
...
# ╔═╡ 3bf3f38b-64e5-445a-9818-885642cce2bb
default_ev = [
	Dict(
		"saddlepoint" => -1,
...
# ╔═╡ 9a413767-299e-4426-a86a-6a6875667b3a
md"""Eigenspaces
...
# ╔═╡ b5408d64-4aa9-480d-a556-feaf7299c242
begin
...
# ╔═╡ 2df72d8a-1526-4da7-9b5c-17b7bad0bcf5
begin
...
# ╔═╡ e4c0a426-fc90-42f7-9f44-2a40cb8027c3
start = Dict(
...
# ╔═╡ 8aef1dc9-4289-4692-8b20-e947c6fb8c27
md"### Gradient Descent Steps"

# ╔═╡ 1d0fb30c-0055-494e-ae09-c9c2a9f1a8ec
md"
...
# ╔═╡ c7d6ec18-b2c8-4451-8074-bfe12539e531
log_rates = log.(abs.(1 .-lr.*[lambda_1,lambda_2]))

# ╔═╡ a88894c3-8056-4571-aa6c-a400cfd9cf52
max_steps = 
...
# ╔═╡ 082c4051-1fe3-47fc-91cb-197e407d8e25
md"##### Gradient Steps
$(@bind gd_steps Slider(1:max_steps, default=max_steps, show_value=true))
"

# ╔═╡ 070e47ef-545b-4d97-8240-c60162dd18c3
begin
...
# ╔═╡ e1e9cc23-61ec-4935-b36d-555ae7b347af
md"### GD with Momentum Steps"

# ╔═╡ f1e46d15-2910-4ab6-9347-b6d1f7f80af4
md"
...
# ╔═╡ 80f101be-db11-4188-bcc8-f7037354647e
md"
...
# ╔═╡ 8fe03b29-06e1-4b50-9d5a-82e7cce08e43
md"##### Momentum Steps
$(@bind mom_steps Slider(1:max_steps, default=max_steps, show_value=true))
"

# ╔═╡ 39bcae2a-b91a-4b98-8737-0d476285b1cc
begin
...
# ╔═╡ 6db1cf62-e5eb-4d1a-a80a-82bd4eb735ee
begin
	losssurface = plot(
...
# ╔═╡ 5d103468-6c55-4068-88d4-6e8292e7d5ba
savefig(gd_viz, "visualize_$(viz_type).svg")

# ╔═╡ 8f5304bb-d905-4a16-bf2c-9ed767826bce
md"# Appendix"
